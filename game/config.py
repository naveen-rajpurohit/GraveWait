...
MAGIC_DMG = 2
MAGIC_SPEED = 175.0
MAGIC_MAX = 100.0              # mana pool: 4 bolts back to back...
MAGIC_COST = 25.0
MAGIC_REGEN = 12.0             # ...then ~2s per bolt, ~8s for a full refill
...
MAX_ENEMIES_MIN = 3
MAX_ENEMIES_MAX = 12
HARD_SPAWN_MULT = 0.45         # hard mode: spawns much sooner...
HARD_EXTRA_ENEMIES = 6         # ...more allowed at once...
HARD_SPEED_MULT = 1.2          # ...they walk faster...
HARD_TIER_SHIFT = 15.0         # ...tougher kinds appear this many % earlier...
HARD_RAMP_MULT = 0.5           # ...and the post-respawn grace ramp is halved
